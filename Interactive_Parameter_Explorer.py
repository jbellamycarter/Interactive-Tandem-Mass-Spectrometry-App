...
with spectrum_tab: 
    ...
    with scol1:
        if reader is not None:
            ...
            st.write("You have selected the ", selected_charge_state, "of", selected_peptide, ", this has a precursor m/z of ", mass.fast_mass2(selected_peptide, ion_type="M", charge=selected_charge_state, aa_mass=aa_mass))
